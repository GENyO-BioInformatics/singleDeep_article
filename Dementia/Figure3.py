...
sc.pl.scatter(adata, basis="umap", color='cell_type', save="figures/figure3a",  palette='tab20', show=False, title = "Cell types", size=0.4)
sc.pl.umap(adata, color='MCC', color_map="viridis_r", save="figures/figure3b",  show=False, title='MCC', size=0.4)
sc.pl.umap(adata, color='APOEContr', color_map="plasma_r", save="figures/figure3c",  show=False, title='APOE Healthy', size=0.4, na_color="lightgray", colorbar_loc=None)
sc.pl.umap(adata, color='APOC1ContrDementia', color_map="plasma_r", save="figures/figure3d",  show=False, title='APOC1 Dementia', size=0.4, na_color="lightgray", colorbar_loc=None)
sc.pl.umap(adata, color='SPP1ContrDementia', color_map="plasma_r", save="figures/figure3e",  show=False, title='SPP1 Dementia', size=0.4, na_color="lightgray", colorbar_loc=None)
